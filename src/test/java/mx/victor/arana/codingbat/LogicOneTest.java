...
/**
	...
	@Test
	public void loneSum(){
		assertEquals(6,LogicOne.loneSum(1,2,3));
		assertEquals(2, LogicOne.loneSum(3,2,3));
		assertEquals(0, LogicOne.loneSum(3,3,3));
	}
}